...
function E(b,a,c){if("function"===typeof a.forEach)a.forEach(c);else if("function"===typeof a.s){a=a.s(!1);for(var d=!1;!d;){try{var e=a.next()}catch(f){d=!0}d||c.call(b,e)}}else if("object"===typeof a)for(d in a)c.call(b,a[d]);else c.call(b,a)}var y=/</g,z=/>/g,x=/&/g,A=/\"/g;t.prototype.a=new r(t.a().b,"",t.a().b);function I(b,a){this.m=b;this.f=a;this.o=!1;this.c=[];this.a=[]}I.prototype.b=function(b){(this.o?this.a:this.c).push(b)};I.prototype.j=function(){var b=this.m,a=this.f,c=J(this.c),d=J(this.a);return function(e,f){return C(t.a(),b,a,c,d,e,f)}};I.prototype.g=function(){return["function(c, i){",'    var n = "'+this.m+'";',"    var r = "+this.f+";","    var t = ["+K(this.c).toString()+"];","    var f = ["+K(this.a).toString()+"];","    return DubStash.C(n, r, t, f, c, i);\n}"].join("\n")};
function J(b){var a=[],c;for(c in b)a.push(b[c].j());return a}function K(b){var a=[],c;for(c in b)a.push(b[c].g());return a};function L(b){this.c=b;this.a=[]}L.prototype.j=function(){var b=this;return function(a,c){var d=t.a(),e=b.c,f=[],g;for(g in b.a)f.push(b.a[g].j());return D(d,e,f,a,c)}};L.prototype.g=function(){return["function(c, i){",'    var n = "'+this.c+'";',"    var s = ["+M(this).toString()+"];","    return DubStash.I(n, s, c, i);\n}"].join("\n")};L.prototype.b=function(b){this.a.push(b)};function M(b){var a=[],c;for(c in b.a)a.push(b.a[c].g());return a};function N(b,a,c){this.f=b;this.c=a;this.a=c}N.prototype.j=function(){var b=this;return function(a,c){return v(t.a(),b.f,b.c,b.a,a,c)}};N.prototype.g=function(){return["function(c, i){","    return DubStash.P("+['"'+this.f+'"',this.c,this.a].join(", ")+", c, i);","}"].join("\n")};N.prototype.b=function(){};function O(b){this.c=b;this.a=[];this.f=0;this.b=[]}O.prototype.j=function(){P(this);var b=Q(this);return function(a,c,d){return u(t.a(),b,a,c,d)}};O.prototype.g=function(){P(this);var b=[],a;for(a in this.b)b.push(this.b[a].g());return["function(d, i, s){","    var r = ["+b.toString()+"];","    return DubStash.T(r, d, i, s);\n}"].join("\n")};function Q(b){var a=[],c;for(c in b.b)a.push(b.b[c].j());return a}
