...
b;for(b in this.v)a.push("DubStash.R.G('"+b+"', "+(new f(this.v[b])).b()+");");return a.join("\n")},registerGlobalData:function(a,b){e.registerGlobalData(a,b)},createContext:function(a,b,c){return new n(a,b,c)}};f.prototype.e=function(){this.D();var a=this.da();return function(b,c,d){return e.O(a,b,c,d)}};f.prototype.b=function(){this.D();return["function(d, i, s){","\tvar r = ["+this.ca().toString()+"];","\treturn DubStash.R.T(r, d, i, s);\n}"].join("\n")};f.prototype.da=function(){var a=[],b;for(b in this.k)a.push(this.k[b].e());
return a};f.prototype.ca=function(){var a=[],b;for(b in this.k)a.push(this.k[b].b());return a};f.prototype.D=function(){f.l.lastIndex=0;for(var a;(a=f.l.exec(this.h))!==m;)if(a[1].length===a[5].length){var b;this.n(a);switch(a[2]){case "if":a[3]?(b="/r"===a[4],a=new k(a[3],b),this.m(a),this.a.push(a)):console.log("Bad condition: "+a[0]);break;case "foreach":a[3]&&(a=new p(a[3]),this.m(a),this.a.push(a));break;case "else":b=q;if(this.a.length){var c=this.a[this.a.length-1];c instanceof k?c.aa():b=
...
f.prototype.n=function(a){a="string"===typeof a?a:this.h.slice(this.w,a.index);a.length?this.m(new h(a)):this.w=f.l.lastIndex};f.prototype.m=function(a){this.a.length?this.a[this.a.length-1].A(a):this.k.push(a);this.w=f.l.lastIndex};f.l=/(\{{2,3})\s*([^\}\s]*)\s*([^\}\s]*)?\s*([^\}\s]*)?(\}{2,3})/g;h.prototype.e=function(){var a=this.h;return function(){return a}};h.prototype.b=function(){return["function(){",'\treturn "'+this.ea(this.h)+'";',"}"].join("\n")};h.V=/"/g;h.Y=/\r?\n/g;h.U=/\\/g;h.prototype.ea=
function(a){return a.replace(h.U,"\\\\").replace(h.V,'\\"').replace(h.Y,"\\n")};s.prototype.e=function(){var a=this;return function(b,c){return e.N(a.f,a.j,a.s,b,c)}};s.prototype.b=function(){return["function(c, i){","\treturn DubStash.R.P("+['"'+this.f+'"',this.j,this.s].join(", ")+", c, i);","}"].join("\n")};k.prototype.aa=function(){this.H=j};k.prototype.A=function(a){(this.H?this.t:this.z).push(a)};k.prototype.e=function(){var a=this.f,b=this.j,c=this.q(this.z),d=this.q(this.t);return function(g,
...
f=[];if(g){a=c.d.length?c.d+"."+a:a;var h=new n(m,a+".[item]",c.c);this.$(g,function(a){for(var c in b)h.o=a,f.push(b[c].call(m,h,d))})}return f.join("")},B:function(a){var b;a&&(b=this.Q[a]);b||(b=r.compile(a),this.Q[a]=b);return b},Q:{},g:function(a,b){b=this.ba(a,b);if(b.name){a=b.name;var c=j}for(var d=new n(b.o,b.d,b.c),g=a.split("."),e=g.length-1,f=0;f<e;f++){var h=this.F(d,g[f]);if(void 0!==h){var k=d.d?[d.d,g[f]].join("."):g[f];d.o=h;d.d=k}else{if(b!==this.r&&!c)return this.g(a,this.r);return}}d=
this.F(d,g[e]);b!==this.r&&(!c&&void 0===d)&&(d=this.g(a,this.r));return d},F:function(a,b){var c=a.o,d;if(c!==m){b in c?d="function"===typeof c[b]?c[b]():c[b]:(c=this.J[b])&&(d=c.call(m,a.c,void 0,a));if("object"===typeof d){if(d instanceof Array)return d.length?d:m;for(var e in d)return d;return m}return d}},ba:function(a,b){var c=a.split("../").length-1;if(c){var d=b.d.split("."),e=d.length-c-1;-1>e&&(console.log("Too many levels to climb from "+b.d+" to "+a+". Will stop at the top."),e=-1);-1!==
e?(d=d.slice(0,e+1).join("."),e=this.g(d,new n(b.c,"",b.c))):(d="",e=b.c);d=new n(e,d,b.c);d.name=a.slice(3*c);return d}return b},$:function(a,b){if("function"===typeof a.forEach)a.forEach(b);else if("function"===typeof a.__iterator__)for(var c=a.__iterator__(q),d=q;!d;){try{var e=c.next()}catch(f){d=j}d||b.call(this,e)}else if("object"===typeof a)for(c in a)b.call(this,a[c]);else b.call(this,a)},s:function(a){return a.replace(e.S,"&amp;").replace(e.X,"&lt;").replace(e.W,"&gt;").replace(e.Z,"&quot;")},
